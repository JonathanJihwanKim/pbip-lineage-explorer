...
export function exportSourceMappingCSV() {
  ...
  csvRows.push('');
  csvRows.push('"Generated by PBIP Lineage Explorer — https://github.com/JonathanJihwanKim/pbip-lineage-explorer"');
...
export function copySourceMappingText() {
  ...
  lines.push('');
  lines.push('Generated by PBIP Lineage Explorer — https://github.com/JonathanJihwanKim/pbip-lineage-explorer');
  return lines.join('\n');
}
